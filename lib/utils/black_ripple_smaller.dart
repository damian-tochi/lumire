...
class BlackRipplePainterSmall extends CustomPainter {
  final double animationValue;
  final Offset tapPosition;

  BlackRipplePainterSmall({required this.animationValue, required this.tapPosition});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double maxRadius = size.width * 0.40;
  ...
  @override
  bool shouldRepaint(covariant BlackRipplePainterSmall oldDelegate) {
